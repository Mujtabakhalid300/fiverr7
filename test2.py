...
cookies = {
    ...
    'NAC': '66NeCwAfRZYRB',
    'NNB': 'LJETARSTT45WO',
    'BUC': 'RFYz9eY9WyVBFW1DanW1AVCyDQVu7UQcatvI7Z4doHw=',
}
...
headers = {
    ...
    # 'cookie': '_fwb=153xPUKhGK7Y0p0tJiz9FHG.1731960655552; NAC=66NeCwAfRZYRB; NNB=LJETARSTT45WO; BUC=RFYz9eY9WyVBFW1DanW1AVCyDQVu7UQcatvI7Z4doHw=',
...
data = '{"checkoutMerchantNo":510244741,"originProductNo":3659054112,"page":3,"pageSize":20,"reviewSearchSortType":"REVIEW_RANKING"}'
response = requests.post(
   'https://smartstore.naver.com/i/v1/contents/reviews/query-pages',
   cookies=cookies,
   headers=headers,
...
try:
    ...
    json_data = response.json()  # .json() method automatically converts content to JSON
    print(len(json_data["contents"]))
    # 2. Define the path for the output JSON file
    output_file = "response_data2.json"
